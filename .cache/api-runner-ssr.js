var plugins = [{
      ...
      options: {"plugins":[],"excludes":["/crown-license","/download/thanks","/fund/donate-btc","/website-about"],"output":"/","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }"},
    },{
