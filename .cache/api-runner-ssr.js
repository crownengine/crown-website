var plugins = [{
      ...
      options: {"plugins":[],"excludes":["/download/thanks","/fund/donate-btc"],"output":"/","createLinkInHead":true,"entryLimit":45000,"query":"{ site { siteMetadata { siteUrl } } allSitePage { nodes { path } } }"},
    },{
