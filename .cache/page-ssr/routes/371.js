...
function NewsCard({title,excerpt,excerptClassName="text-sm",date,image,variant="regular"}){if(variant==="regular"){return/*#__PURE__*/index_js_default().createElement("article",{className:"bg-white rounded-2xl shadow-md overflow-hidden flex flex-col h-full"},/*#__PURE__*/index_js_default().createElement("div",{className:"w-full h-64 overflow-hidden"},image&&/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.mV,{image:image,alt:title,className:"w-full h-full object-cover"})),/*#__PURE__*/index_js_default().createElement("div",{className:"p-4 flex-1 flex flex-col justify-end"},/*#__PURE__*/index_js_default().createElement("h3",{className:"text-lg font-semibold mb-2"},title),excerpt&&/*#__PURE__*/index_js_default().createElement("p",{className:`${excerptClassName} text-gray-700 mb-2 line-clamp-3`},excerpt),/*#__PURE__*/index_js_default().createElement("p",{className:"text-sm text-gray-500"},date)));}return/*#__PURE__*/index_js_default().createElement("article",{className:"bg-white rounded-2xl shadow-md overflow-hidden flex h-full"},/*#__PURE__*/index_js_default().createElement("div",{className:"w-1/3 overflow-hidden"},image?/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.mV,{image:image,alt:title,className:"w-full h-full object-cover"}):/*#__PURE__*/index_js_default().createElement("div",{className:"w-full h-full bg-gray-100"})),/*#__PURE__*/index_js_default().createElement("div",{className:"p-3 flex-1 flex flex-col justify-center"},/*#__PURE__*/index_js_default().createElement("h3",{className:"text-base font-semibold leading-snug mb-1 line-clamp-2"},title),excerpt&&/*#__PURE__*/index_js_default().createElement("p",{className:`${excerptClassName} text-gray-700 mb-1 line-clamp-2`},excerpt),/*#__PURE__*/index_js_default().createElement("p",{className:"text-xs text-gray-500 mt-auto"},date)));}
;// ./src/components/news-list.jsx
function NewsList({edges,nodes,limit=Infinity,start=0,Card=NewsCard,variant="regular",excerptClassName,itemClassName="flex-1 min-w-[300px]",listClassName="flex flex-wrap gap-4"}){const allItems=(nodes||(edges===null||edges===void 0?void 0:edges.map(e=>e.node))||[]).filter(node=>{var _node$frontmatter;return!!(node!==null&&node!==void 0&&(_node$frontmatter=node.frontmatter)!==null&&_node$frontmatter!==void 0&&_node$frontmatter.date);});const items=allItems.slice(start,start+limit);if(!items.length)return null;return/*#__PURE__*/index_js_default().createElement("section",{className:"text-left text-gray-600"},/*#__PURE__*/index_js_default().createElement("div",{className:listClassName},items.map(node=>{var _fm$image,_fm$image$childImageS;const fm=node.frontmatter||{};const key=node.id||fm.slug||fm.title;return/*#__PURE__*/index_js_default().createElement("div",{key:key,className:`${itemClassName}`},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:fm.slug,"aria-label":fm.title},/*#__PURE__*/index_js_default().createElement(Card,{image:(0,gatsby_image_module/* getImage */.Qp)((_fm$image=fm.image)===null||_fm$image===void 0?void 0:(_fm$image$childImageS=_fm$image.childImageSharp)===null||_fm$image$childImageS===void 0?void 0:_fm$image$childImageS.gatsbyImageData),title:fm.title,excerpt:node.excerpt,excerptClassName:excerptClassName,date:fm.date,variant:variant})));})));}NewsList.propTypes={edges:(prop_types_default()).array,nodes:(prop_types_default()).array,limit:(prop_types_default()).number,start:(prop_types_default()).number,Card:(prop_types_default()).elementType,variant:(prop_types_default()).string,excerptClassName:(prop_types_default()).string,itemClassName:(prop_types_default()).string,listClassName:(prop_types_default()).string};
...
function Footer(){const data=(0,gatsby_browser_entry.useStaticQuery)("3304111942");return/*#__PURE__*/index_js_default().createElement("footer",{className:"mt-auto bg-gray-300 px-6 py-16 text-sm lg:px-8"},/*#__PURE__*/index_js_default().createElement(clamp/* default */.A,null,/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-wrap"},/*#__PURE__*/index_js_default().createElement("div",{className:"w-1/2 md:w-1/4"},/*#__PURE__*/index_js_default().createElement("h2",{className:"font-semibold uppercase pb-1 text-sm"},"Download"),/*#__PURE__*/index_js_default().createElement("nav",{className:"mb-2"},/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-col space-y-2 lg:mt-0 text-gray-700"},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-gray-900",to:"/download"},"Latest Crown"),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-gray-900",rel:"noreferrer",target:"_blank",href:"https://github.com/crownengine/crown/"},"Source Code"),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-gray-900",rel:"noreferrer",target:"_blank",href:"https://docs.crownengine.org/html/latest/changelog.html"},"Changelog"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-gray-900",to:"/crown-license"},"License")))),/*#__PURE__*/index_js_default().createElement("div",{className:"w-1/2 md:w-1/4"},/*#__PURE__*/index_js_default().createElement("h2",{className:"font-semibold uppercase pb-1 text-sm"},"About"),/*#__PURE__*/index_js_default().createElement("nav",{className:"mb-2"},/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-col space-y-2 lg:mt-0 text-gray-700"},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-gray-900",to:"/about"},"Mission & Activities"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-gray-900",to:"/about/credits"},"Credits"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-gray-900",to:"/roadmap"},"Roadmap"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-gray-900",to:"/privacy-policy"},"Privacy Policy"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-gray-900",to:"/cookie-policy"},"Cookie Policy")))),/*#__PURE__*/index_js_default().createElement("div",{className:"w-1/2 md:w-1/4"},/*#__PURE__*/index_js_default().createElement("h2",{className:"font-semibold uppercase pb-1 text-sm"},"Support"),/*#__PURE__*/index_js_default().createElement("nav",{className:"mb-2"},/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-col space-y-2 lg:mt-0 text-gray-700"},/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-gray-900",rel:"noreferrer",target:"_blank",href:"https://docs.crownengine.org"},"User Manual"),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-gray-900",rel:"noreferrer",target:"_blank",href:"https://docs.crownengine.org/html/latest/hackers/contributing.html"},"Developer Manual"),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-gray-900",rel:"noreferrer",target:"_blank",href:"https://discord.gg/invite/CeXVWCT"},"Community"))),/*#__PURE__*/index_js_default().createElement("h2",{className:"mt-4 font-semibold uppercase pb-1 text-sm"},"News"),/*#__PURE__*/index_js_default().createElement("nav",{className:"mb-2"},/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-col space-y-2 lg:mt-0 text-gray-700"},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-gray-900",to:"/news"},"Latest News"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-gray-900",to:"/media-coverage"},"Media Coverage")))),/*#__PURE__*/index_js_default().createElement("div",{className:"w-1/2 md:w-1/4"},/*#__PURE__*/index_js_default().createElement("h2",{className:"font-semibold uppercase pb-1 text-sm"},"Follow Crown"),/*#__PURE__*/index_js_default().createElement("nav",{className:"mb-2"},/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-row text-lg text-gray-700"},/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-gray-900",rel:"noreferrer",target:"_blank",href:"https://github.com/crownengine/crown/",title:"Crown Official GitHub page"},/*#__PURE__*/index_js_default().createElement(fa6/* FaGithub */.hL4,{className:"mr-3","aria-label":"GitHub"})),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-gray-900",rel:"noreferrer",target:"_blank",href:"https://discord.gg/invite/CeXVWCT",title:"Join Crown on Discord"},/*#__PURE__*/index_js_default().createElement(fa6/* FaDiscord */.O4U,{className:"mr-3","aria-label":"Discord"})),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-gray-900",rel:"noreferrer",target:"_blank",href:"https://www.twitter.com/crown_engine",title:"Follow Crown on X"},/*#__PURE__*/index_js_default().createElement(fa6/* FaXTwitter */.TCj,{className:"mr-3","aria-label":"X"})),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-gray-900",rel:"noreferrer",target:"_blank",href:"https://www.linkedin.com/company/crownengine",title:"Follow Crown on LinkedIn"},/*#__PURE__*/index_js_default().createElement(fa6/* FaLinkedin */.QEs,{className:"mr-3","aria-label":"LinkedIn"})),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-gray-900",rel:"noreferrer",target:"_blank",href:"https://mastodon.gamedev.place/@crownengine",title:"Follow Crown on Mastodon"},/*#__PURE__*/index_js_default().createElement(fa6/* FaMastodon */.hHC,{className:"mr-3","aria-label":"Mastodon"})),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-gray-900",rel:"noreferrer",target:"_blank",href:"https://bsky.app/profile/crownengine.org",title:"Follow Crown on Bluesky"},/*#__PURE__*/index_js_default().createElement(fa6/* FaBluesky */.fr_,{className:"mr-3","aria-label":"Bluesky"})))),/*#__PURE__*/index_js_default().createElement("h2",{className:"mt-4 font-semibold uppercase pb-1 text-sm"},"Support Crown"),/*#__PURE__*/index_js_default().createElement("nav",{className:"mb-2"},/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-col space-y-2 lg:mt-0 text-gray-700 hover:text-gray-900"},/*#__PURE__*/index_js_default().createElement(donate_button/* default */.A,null))))),/*#__PURE__*/index_js_default().createElement("div",{className:"mx-auto mt-4 flex max-w-screen-xl flex-col items-center"},/*#__PURE__*/index_js_default().createElement("div",{className:"mt-4 flex flex-wrap place-items-center justify-center gap-x-3 gap-y-2"},/*#__PURE__*/index_js_default().createElement("span",null,"\xA9",new Date().getFullYear()," ",data.site.siteMetadata.org_title),/*#__PURE__*/index_js_default().createElement("span",{"aria-hidden":"true"},"\xB7"),/*#__PURE__*/index_js_default().createElement("span",null,"Tax Code/VAT No. ",data.site.siteMetadata.org_tax_id),/*#__PURE__*/index_js_default().createElement("span",{"aria-hidden":"true"},"\xB7"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"text-gray-700 hover:text-gray-900",to:"/website-about"},"Website Credits")))));}
;// ./src/components/header.jsx
function Header(){const{0:isOpen,1:setIsOpen}=(0,index_js_.useState)(false);const data=(0,gatsby_browser_entry.useStaticQuery)("3789038097");const menu_items=data.site.siteMetadata.menu;return/*#__PURE__*/index_js_default().createElement(clamp/* default */.A,null,/*#__PURE__*/index_js_default().createElement("nav",{className:"relative flex flex-wrap items-center justify-between","aria-label":"Primary navigation"},/*#__PURE__*/index_js_default().createElement("div",{className:"px-4"},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"header-logo h-10 w-24 lg:w-36",to:"/","aria-label":"Crown Engine home"})),/*#__PURE__*/index_js_default().createElement("div",{className:"block lg:hidden px-4"},/*#__PURE__*/index_js_default().createElement("button",{className:"navbar-burger flex items-center py-2 px-4 my-2 text-indigo-500 border border-indigo-500",onClick:()=>setIsOpen(open=>!open),"aria-label":"Menu","aria-controls":"primary-navigation","aria-expanded":isOpen},/*#__PURE__*/index_js_default().createElement("svg",{className:"fill-current h-3 w-3",viewBox:"0 0 20 20",xmlns:"http://www.w3.org/2000/svg"},/*#__PURE__*/index_js_default().createElement("title",null,"Menu"),/*#__PURE__*/index_js_default().createElement("path",{d:"M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"})))),/*#__PURE__*/index_js_default().createElement("div",{id:"primary-navigation",className:`${isOpen?"block":"hidden"} absolute left-0 top-full z-50 w-full bg-gray-100 px-4 text-gray-900 shadow-lg lg:static lg:z-auto lg:block lg:w-auto lg:bg-transparent lg:shadow-none`},/*#__PURE__*/index_js_default().createElement("ul",{className:"flex flex-col lg:flex-row"},menu_items.map((item,index)=>{if(item.label==="Donate"){return/*#__PURE__*/index_js_default().createElement("li",{key:index,className:"border-b border-gray-300 hover:text-indigo-600 lg:border-b-0"},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"block py-4 pl-2 pr-2 lg:hidden",activeClassName:"shadow-[inset_0_-4px_0_0_#4f46e5]"/* indigo-600 */,partiallyActive:true,to:item.link,onClick:()=>setIsOpen(false)},/*#__PURE__*/index_js_default().createElement(fa6/* FaHeart */.Mbv,{className:"mr-2 inline","aria-hidden":"true"}),item.label),/*#__PURE__*/index_js_default().createElement("div",{className:"hidden py-2 pl-2 pr-2 lg:block"},/*#__PURE__*/index_js_default().createElement(donate_button/* default */.A,null)));}const is_external=!item.link.startsWith("/");return/*#__PURE__*/index_js_default().createElement("li",{key:index,className:"border-b border-gray-300 hover:text-indigo-600 lg:border-b-0"},is_external?/*#__PURE__*/index_js_default().createElement("a",{className:"block py-4 pl-2 pr-2",rel:"noreferrer",target:"_blank",href:item.link},item.label):/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"block py-4 pl-2 pr-2",activeClassName:"shadow-[inset_0_-4px_0_0_#4f46e5]"/* indigo-600 */,partiallyActive:true,to:item.link,onClick:()=>setIsOpen(false)},item.label));})))));}
