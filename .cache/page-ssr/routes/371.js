...
;// ./src/components/news-card.jsx
function NewsCard({title,excerpt,excerptClassName="text-small",date,image,variant="regular"}){if(variant==="regular"||variant==="featured"){const featured=variant==="featured";return/*#__PURE__*/index_js_default().createElement("article",{className:"widget group flex h-full flex-col overflow-hidden"},/*#__PURE__*/index_js_default().createElement("div",{className:featured?"h-64 w-full overflow-hidden lg:relative lg:h-auto lg:min-h-0 lg:flex-1":"h-64 w-full overflow-hidden"},image&&/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.mV,{image:image,alt:title,className:`${featured?"lg:!absolute lg:inset-0":""} h-full w-full transform-gpu object-cover transition-transform duration-200 ease-out group-hover:scale-[1.04] motion-reduce:group-hover:scale-100`})),/*#__PURE__*/index_js_default().createElement("div",{className:featured?"flex flex-col justify-end p-4":"flex flex-1 flex-col justify-end p-4"},/*#__PURE__*/index_js_default().createElement("h3",{className:"text-lead font-semibold mb-2"},title),excerpt&&/*#__PURE__*/index_js_default().createElement("p",{className:`${excerptClassName} text-ink mb-2 line-clamp-3`},excerpt),/*#__PURE__*/index_js_default().createElement("p",{className:"text-small text-muted"},date)));}if(variant==="overlay"){return/*#__PURE__*/index_js_default().createElement("article",{className:"widget group relative h-40 overflow-hidden sm:h-44 lg:h-auto"},/*#__PURE__*/index_js_default().createElement("div",{className:"hidden w-full lg:block",style:{aspectRatio:image?image.width/image.height:16/9},"aria-hidden":"true"}),image?/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.mV,{image:image,alt:title,className:"!absolute inset-0 h-full w-full transform-gpu object-cover transition-transform duration-200 ease-out group-hover:scale-[1.04] motion-reduce:group-hover:scale-100"}):/*#__PURE__*/index_js_default().createElement("div",{className:"absolute inset-0 bg-panel"}),/*#__PURE__*/index_js_default().createElement("h3",{className:"absolute bottom-2 left-2 z-10 max-w-[calc(100%-1rem)] rounded-widget bg-button-white/85 px-2 py-1 text-small font-semibold leading-tight text-cool-horizon-950 line-clamp-2"},title));}return/*#__PURE__*/index_js_default().createElement("article",{className:"widget group flex h-full overflow-hidden"},/*#__PURE__*/index_js_default().createElement("div",{className:"w-1/3 overflow-hidden"},image?/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.mV,{image:image,alt:title,className:"h-full w-full transform-gpu object-cover transition-transform duration-200 ease-out group-hover:scale-[1.04] motion-reduce:group-hover:scale-100"}):/*#__PURE__*/index_js_default().createElement("div",{className:"w-full h-full bg-canvas"})),/*#__PURE__*/index_js_default().createElement("div",{className:"p-3 flex-1 flex flex-col justify-center"},/*#__PURE__*/index_js_default().createElement("h3",{className:"text-body font-semibold leading-tight mb-1 line-clamp-2"},title),excerpt&&/*#__PURE__*/index_js_default().createElement("p",{className:`${excerptClassName} text-ink mb-1 line-clamp-2`},excerpt),/*#__PURE__*/index_js_default().createElement("p",{className:"text-caption text-muted mt-auto"},date)));}
;// ./src/components/news-list.jsx
function NewsList({edges,nodes,limit=Infinity,start=0,Card=NewsCard,variant="regular",excerptClassName,itemClassName="flex-1 min-w-[300px]",linkClassName="",listClassName="flex flex-wrap gap-4",sectionClassName=""}){const allItems=(nodes||(edges===null||edges===void 0?void 0:edges.map(e=>e.node))||[]).filter(node=>{var _node$frontmatter;return!!(node!==null&&node!==void 0&&(_node$frontmatter=node.frontmatter)!==null&&_node$frontmatter!==void 0&&_node$frontmatter.date);});const items=allItems.slice(start,start+limit);if(!items.length)return null;return/*#__PURE__*/index_js_default().createElement("section",{className:`text-left text-muted ${sectionClassName}`.trim()},/*#__PURE__*/index_js_default().createElement("div",{className:listClassName},items.map(node=>{var _fm$image,_fm$image$childImageS;const fm=node.frontmatter||{};const key=node.id||fm.slug||fm.title;return/*#__PURE__*/index_js_default().createElement("div",{key:key,className:`${itemClassName}`},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:linkClassName,to:fm.slug,"aria-label":fm.title},/*#__PURE__*/index_js_default().createElement(Card,{image:(0,gatsby_image_module/* getImage */.Qp)((_fm$image=fm.image)===null||_fm$image===void 0?void 0:(_fm$image$childImageS=_fm$image.childImageSharp)===null||_fm$image$childImageS===void 0?void 0:_fm$image$childImageS.gatsbyImageData),title:fm.title,excerpt:node.excerpt,excerptClassName:excerptClassName,date:fm.date,variant:variant})));})));}NewsList.propTypes={edges:(prop_types_default()).array,nodes:(prop_types_default()).array,limit:(prop_types_default()).number,start:(prop_types_default()).number,Card:(prop_types_default()).elementType,variant:(prop_types_default()).string,excerptClassName:(prop_types_default()).string,itemClassName:(prop_types_default()).string,linkClassName:(prop_types_default()).string,listClassName:(prop_types_default()).string,sectionClassName:(prop_types_default()).string};
...
/* harmony import */ var _fontsource_variable_inter_files_inter_latin_wght_normal_woff2__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(5220);
...
const sectionHeadingClass="mb-3 text-small font-semibold uppercase text-muted";function Footer(){const data=(0,gatsby_browser_entry.useStaticQuery)("3304111942");return/*#__PURE__*/index_js_default().createElement("footer",{className:"mt-auto bg-surface px-6 py-16 text-small lg:px-8"},/*#__PURE__*/index_js_default().createElement(clamp/* default */.A,null,/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-wrap"},/*#__PURE__*/index_js_default().createElement("div",{className:"w-1/2 md:w-1/4"},/*#__PURE__*/index_js_default().createElement("h2",{className:sectionHeadingClass},"Download"),/*#__PURE__*/index_js_default().createElement("nav",{className:"mb-2"},/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-col space-y-2 lg:mt-0 text-ink"},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-ink",to:"/download"},"Latest Crown"),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-ink",rel:"noreferrer",target:"_blank",href:"https://github.com/crownengine/crown/"},"Source Code"),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-ink",rel:"noreferrer",target:"_blank",href:"https://docs.crownengine.org/html/latest/changelog.html"},"Changelog"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-ink",to:"/crown-license"},"License")))),/*#__PURE__*/index_js_default().createElement("div",{className:"w-1/2 md:w-1/4"},/*#__PURE__*/index_js_default().createElement("h2",{className:sectionHeadingClass},"About"),/*#__PURE__*/index_js_default().createElement("nav",{className:"mb-2"},/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-col space-y-2 lg:mt-0 text-ink"},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-ink",to:"/about"},"Mission & Activities"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-ink",to:"/about/credits"},"Credits"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-ink",to:"/roadmap"},"Roadmap"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-ink",to:"/privacy-policy"},"Privacy Policy"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-ink",to:"/cookie-policy"},"Cookie Policy")))),/*#__PURE__*/index_js_default().createElement("div",{className:"w-1/2 md:w-1/4"},/*#__PURE__*/index_js_default().createElement("h2",{className:sectionHeadingClass},"Support"),/*#__PURE__*/index_js_default().createElement("nav",{className:"mb-2"},/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-col space-y-2 lg:mt-0 text-ink"},/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-ink",rel:"noreferrer",target:"_blank",href:"https://docs.crownengine.org"},"User Manual"),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-ink",rel:"noreferrer",target:"_blank",href:"https://docs.crownengine.org/html/latest/hackers/contributing.html"},"Developer Manual"),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-ink",rel:"noreferrer",target:"_blank",href:"https://discord.gg/invite/CeXVWCT"},"Community"))),/*#__PURE__*/index_js_default().createElement("h2",{className:`mt-4 ${sectionHeadingClass}`},"News"),/*#__PURE__*/index_js_default().createElement("nav",{className:"mb-2"},/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-col space-y-2 lg:mt-0 text-ink"},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-ink",to:"/news"},"Latest News"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"hover:text-ink",to:"/media-coverage"},"Media Coverage")))),/*#__PURE__*/index_js_default().createElement("div",{className:"w-1/2 md:w-1/4"},/*#__PURE__*/index_js_default().createElement("h2",{className:sectionHeadingClass},"Follow Crown"),/*#__PURE__*/index_js_default().createElement("nav",{className:"mb-2"},/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-row text-[1.5rem] text-ink"},/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-ink",rel:"noreferrer",target:"_blank",href:"https://github.com/crownengine/crown/",title:"Crown Official GitHub page"},/*#__PURE__*/index_js_default().createElement(fa6/* FaGithub */.hL4,{className:"mr-3","aria-label":"GitHub"})),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-ink",rel:"noreferrer",target:"_blank",href:"https://discord.gg/invite/CeXVWCT",title:"Join Crown on Discord"},/*#__PURE__*/index_js_default().createElement(fa6/* FaDiscord */.O4U,{className:"mr-3","aria-label":"Discord"})),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-ink",rel:"noreferrer",target:"_blank",href:"https://www.twitter.com/crown_engine",title:"Follow Crown on X"},/*#__PURE__*/index_js_default().createElement(fa6/* FaXTwitter */.TCj,{className:"mr-3","aria-label":"X"})),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-ink",rel:"noreferrer",target:"_blank",href:"https://www.linkedin.com/company/crownengine",title:"Follow Crown on LinkedIn"},/*#__PURE__*/index_js_default().createElement(fa6/* FaLinkedin */.QEs,{className:"mr-3","aria-label":"LinkedIn"})),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-ink",rel:"noreferrer",target:"_blank",href:"https://mastodon.gamedev.place/@crownengine",title:"Follow Crown on Mastodon"},/*#__PURE__*/index_js_default().createElement(fa6/* FaMastodon */.hHC,{className:"mr-3","aria-label":"Mastodon"})),/*#__PURE__*/index_js_default().createElement("a",{className:"hover:text-ink",rel:"noreferrer",target:"_blank",href:"https://bsky.app/profile/crownengine.org",title:"Follow Crown on Bluesky"},/*#__PURE__*/index_js_default().createElement(fa6/* FaBluesky */.fr_,{className:"mr-3","aria-label":"Bluesky"})))),/*#__PURE__*/index_js_default().createElement("h2",{className:`mt-4 ${sectionHeadingClass}`},"Support Crown"),/*#__PURE__*/index_js_default().createElement("nav",{className:"mb-2"},/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-col space-y-2 lg:mt-0 text-ink hover:text-ink"},/*#__PURE__*/index_js_default().createElement(donate_button/* default */.A,null))))),/*#__PURE__*/index_js_default().createElement("div",{className:"mx-auto mt-8 flex max-w-screen-xl flex-col items-center border-t border-line pt-8"},/*#__PURE__*/index_js_default().createElement("div",{className:"flex flex-wrap place-items-center justify-center gap-x-3 gap-y-2"},/*#__PURE__*/index_js_default().createElement("span",null,"\xA9",new Date().getFullYear()," ",data.site.siteMetadata.org_title),/*#__PURE__*/index_js_default().createElement("span",{"aria-hidden":"true"},"\xB7"),/*#__PURE__*/index_js_default().createElement("span",null,"Tax Code/VAT No. ",data.site.siteMetadata.org_tax_id),/*#__PURE__*/index_js_default().createElement("span",{"aria-hidden":"true"},"\xB7"),/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"text-ink hover:text-ink",to:"/website-about"},"Website")))));}
;// ./src/components/header.jsx
function Header(){const{0:isOpen,1:setIsOpen}=(0,index_js_.useState)(false);const data=(0,gatsby_browser_entry.useStaticQuery)("3789038097");const menu_items=data.site.siteMetadata.menu;return/*#__PURE__*/index_js_default().createElement(clamp/* default */.A,null,/*#__PURE__*/index_js_default().createElement("nav",{className:"relative flex flex-wrap items-center justify-between py-1 lg:py-0","aria-label":"Primary navigation"},/*#__PURE__*/index_js_default().createElement("div",{className:"px-4"},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"header-logo h-10 w-24 lg:w-36",to:"/","aria-label":"Crown Engine home"})),/*#__PURE__*/index_js_default().createElement("div",{className:"block lg:hidden px-4"},/*#__PURE__*/index_js_default().createElement("button",{className:"button button-secondary button-compact navbar-burger my-2",onClick:()=>setIsOpen(open=>!open),"aria-label":"Menu","aria-controls":"primary-navigation","aria-expanded":isOpen},/*#__PURE__*/index_js_default().createElement("svg",{className:"fill-current h-3 w-3",viewBox:"0 0 20 20",xmlns:"http://www.w3.org/2000/svg"},/*#__PURE__*/index_js_default().createElement("title",null,"Menu"),/*#__PURE__*/index_js_default().createElement("path",{d:"M0 3h20v2H0V3zm0 6h20v2H0V9zm0 6h20v2H0v-2z"})))),/*#__PURE__*/index_js_default().createElement("div",{id:"primary-navigation",className:`${isOpen?"block":"hidden"} absolute left-0 top-full z-50 w-full bg-canvas px-4 text-ink lg:static lg:z-auto lg:block lg:w-auto lg:bg-transparent`},/*#__PURE__*/index_js_default().createElement("ul",{className:"flex flex-col lg:flex-row"},menu_items.map((item,index)=>{if(item.label==="Donate"){return/*#__PURE__*/index_js_default().createElement("li",{key:index,className:"border-b border-line hover:text-brand-hover lg:border-b-0"},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"block py-4 pl-2 pr-2 lg:hidden",activeClassName:"font-semibold text-brand",partiallyActive:true,to:item.link,onClick:()=>setIsOpen(false)},/*#__PURE__*/index_js_default().createElement(fa6/* FaHeart */.Mbv,{className:"mr-2 inline","aria-hidden":"true"}),item.label),/*#__PURE__*/index_js_default().createElement("div",{className:"hidden py-2 pl-2 pr-2 lg:block"},/*#__PURE__*/index_js_default().createElement(donate_button/* default */.A,null)));}const is_external=!item.link.startsWith("/");return/*#__PURE__*/index_js_default().createElement("li",{key:index,className:"border-b border-line hover:text-brand-hover lg:border-b-0"},is_external?/*#__PURE__*/index_js_default().createElement("a",{className:"block py-4 pl-2 pr-2",rel:"noreferrer",target:"_blank",href:item.link},item.label):/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{className:"block py-4 pl-2 pr-2",activeClassName:"font-semibold text-brand",partiallyActive:true,to:item.link,onClick:()=>setIsOpen(false)},item.label));})))));}
;// ./src/components/layout.jsx
function Layout({children}){return/*#__PURE__*/index_js_default().createElement((index_js_default()).Fragment,null,/*#__PURE__*/index_js_default().createElement("div",{className:"bg-canvas"},/*#__PURE__*/index_js_default().createElement(Header,null),/*#__PURE__*/index_js_default().createElement("main",null,children),/*#__PURE__*/index_js_default().createElement(Footer,null)));}Layout.propTypes={children:(prop_types_default()).node.isRequired};
