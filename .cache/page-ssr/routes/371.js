...
function NewsCard({title,excerpt,excerptClassName="text-small",date,image,variant="regular"}){if(variant==="regular"){return/*#__PURE__*/index_js_default().createElement("article",{className:"widget group flex h-full flex-col overflow-hidden"},/*#__PURE__*/index_js_default().createElement("div",{className:"w-full h-64 overflow-hidden"},image&&/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.mV,{image:image,alt:title,className:"h-full w-full transform-gpu object-cover transition-transform duration-200 ease-out group-hover:scale-[1.04] motion-reduce:group-hover:scale-100"})),/*#__PURE__*/index_js_default().createElement("div",{className:"p-4 flex-1 flex flex-col justify-end"},/*#__PURE__*/index_js_default().createElement("h3",{className:"text-lead font-semibold mb-2"},title),excerpt&&/*#__PURE__*/index_js_default().createElement("p",{className:`${excerptClassName} text-ink mb-2 line-clamp-3`},excerpt),/*#__PURE__*/index_js_default().createElement("p",{className:"text-small text-muted"},date)));}if(variant==="overlay"){return/*#__PURE__*/index_js_default().createElement("article",{className:"widget group relative h-40 overflow-hidden sm:h-44 lg:h-full"},image?/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.mV,{image:image,alt:title,className:"absolute inset-0 h-full w-full transform-gpu object-cover transition-transform duration-200 ease-out group-hover:scale-[1.04] motion-reduce:group-hover:scale-100"}):/*#__PURE__*/index_js_default().createElement("div",{className:"absolute inset-0 bg-panel"}),/*#__PURE__*/index_js_default().createElement("h3",{className:"absolute bottom-2 left-2 z-10 max-w-[calc(100%-1rem)] rounded-widget bg-button-white/85 px-2 py-1 text-small font-semibold leading-tight text-cool-horizon-950 line-clamp-2"},title));}return/*#__PURE__*/index_js_default().createElement("article",{className:"widget group flex h-full overflow-hidden"},/*#__PURE__*/index_js_default().createElement("div",{className:"w-1/3 overflow-hidden"},image?/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.mV,{image:image,alt:title,className:"h-full w-full transform-gpu object-cover transition-transform duration-200 ease-out group-hover:scale-[1.04] motion-reduce:group-hover:scale-100"}):/*#__PURE__*/index_js_default().createElement("div",{className:"w-full h-full bg-canvas"})),/*#__PURE__*/index_js_default().createElement("div",{className:"p-3 flex-1 flex flex-col justify-center"},/*#__PURE__*/index_js_default().createElement("h3",{className:"text-body font-semibold leading-tight mb-1 line-clamp-2"},title),excerpt&&/*#__PURE__*/index_js_default().createElement("p",{className:`${excerptClassName} text-ink mb-1 line-clamp-2`},excerpt),/*#__PURE__*/index_js_default().createElement("p",{className:"text-caption text-muted mt-auto"},date)));}
