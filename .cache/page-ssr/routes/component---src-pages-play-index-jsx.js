...
function HeroImage({title="Headline",subtitle="Subtitle",src="/play/physics.jpg",alt="An image",heightClass="h-96"}){return/*#__PURE__*/index_js_default().createElement("section",{className:`relative w-full ${heightClass} overflow-hidden rounded-xl`},/*#__PURE__*/index_js_default().createElement("img",{src:src,alt:alt,loading:"lazy",className:"w-full h-full object-cover"}),/*#__PURE__*/index_js_default().createElement("div",{"aria-hidden":"true",className:"absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"}),/*#__PURE__*/index_js_default().createElement("div",{className:"absolute inset-0 flex items-end justify-start p-6 md:p-12"},/*#__PURE__*/index_js_default().createElement("div",{className:"max-w-2xl text-left"},/*#__PURE__*/index_js_default().createElement("h2",{className:"text-2xl md:text-4xl font-extrabold leading-tight text-white drop-shadow"},title),subtitle&&/*#__PURE__*/index_js_default().createElement("p",{className:"mt-2 text-sm md:text-lg text-white/90"},subtitle))));}
;// ./src/pages/play/index.jsx
function Play(){return/*#__PURE__*/index_js_default().createElement(layout/* default */.A,null,/*#__PURE__*/index_js_default().createElement("div",{className:"bg-[url('../images/index/luna-background.svg')] bg-left-top bg-cover"},/*#__PURE__*/index_js_default().createElement(clamp/* default */.A,null,/*#__PURE__*/index_js_default().createElement("section",{className:"py-24 px-4 text-left text-red-600"},/*#__PURE__*/index_js_default().createElement("h1",{className:"text-6xl mb-6 font-bold bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500 bg-clip-text text-transparent drop-shadow-md"},"Take a Bite of The Tech"),/*#__PURE__*/index_js_default().createElement("p",{className:"text-2xl mb-24 text-gray-300"},"Play a selection of interactive demos in-browser."),/*#__PURE__*/index_js_default().createElement("a",{href:"https://play.crownengine.org/physics","data-nosnippet":true},/*#__PURE__*/index_js_default().createElement(HeroImage,{src:"/play/physics.jpg",title:"Physics",subtitle:"First/third-person controls, kinematic platforms, slopes, stairs, triggers, raycasts and more.",heightClass:"h-96"})),/*#__PURE__*/index_js_default().createElement("p",{className:"mb-32"})))));}const Head=()=>/*#__PURE__*/index_js_default().createElement(seo/* default */.A,{title:"Play",description:"Play a selection of interactive demos without leaving the browser."});
