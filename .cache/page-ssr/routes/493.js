...
function NewsCard({title,excerpt,date,image,variant="regular"}){if(variant==="regular"){return/*#__PURE__*/index_js_default().createElement("article",{className:"bg-white rounded-2xl shadow-md overflow-hidden flex flex-col h-full"},/*#__PURE__*/index_js_default().createElement("div",{className:"w-full h-64 overflow-hidden"},image&&/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.mV,{image:image,alt:title,className:"w-full h-full object-cover"})),/*#__PURE__*/index_js_default().createElement("div",{className:"p-4 flex-1 flex flex-col justify-end"},/*#__PURE__*/index_js_default().createElement("h3",{className:"text-lg font-semibold mb-2"},title),excerpt&&/*#__PURE__*/index_js_default().createElement("p",{className:"text-sm text-gray-700 mb-2 line-clamp-3"},excerpt),/*#__PURE__*/index_js_default().createElement("p",{className:"text-sm text-gray-500"},date)));}return/*#__PURE__*/index_js_default().createElement("article",{className:"bg-white rounded-2xl shadow-md overflow-hidden flex h-full"},/*#__PURE__*/index_js_default().createElement("div",{className:"w-1/3 overflow-hidden"},image?/*#__PURE__*/index_js_default().createElement(gatsby_image_module/* GatsbyImage */.mV,{image:image,alt:title,className:"w-full h-full object-cover"}):/*#__PURE__*/index_js_default().createElement("div",{className:"w-full h-full bg-gray-100"})),/*#__PURE__*/index_js_default().createElement("div",{className:"p-3 flex-1 flex flex-col justify-center"},/*#__PURE__*/index_js_default().createElement("h3",{className:"text-base font-semibold leading-snug mb-1 line-clamp-2"},title),excerpt&&/*#__PURE__*/index_js_default().createElement("p",{className:"text-sm text-gray-700 mb-1 line-clamp-2"},excerpt),/*#__PURE__*/index_js_default().createElement("p",{className:"text-xs text-gray-500 mt-auto"},date)));}
;// ./src/components/news-list.jsx
function NewsList({edges,nodes,limit=Infinity,start=0,Card=NewsCard,variant="regular",itemClassName="flex-1 min-w-[300px]",listClassName="flex flex-wrap gap-4"}){const allItems=(nodes||(edges===null||edges===void 0?void 0:edges.map(e=>e.node))||[]).filter(node=>{var _node$frontmatter;return!!(node!==null&&node!==void 0&&(_node$frontmatter=node.frontmatter)!==null&&_node$frontmatter!==void 0&&_node$frontmatter.date);});const items=allItems.slice(start,start+limit);if(!items.length)return null;return/*#__PURE__*/index_js_default().createElement("section",{className:"text-left text-gray-600"},/*#__PURE__*/index_js_default().createElement("div",{className:listClassName},items.map(node=>{var _fm$image,_fm$image$childImageS;const fm=node.frontmatter||{};const key=node.id||fm.slug||fm.title;return/*#__PURE__*/index_js_default().createElement("div",{key:key,className:`${itemClassName}`},/*#__PURE__*/index_js_default().createElement(gatsby_browser_entry.Link,{to:fm.slug,"aria-label":fm.title},/*#__PURE__*/index_js_default().createElement(Card,{image:(0,gatsby_image_module/* getImage */.Qp)((_fm$image=fm.image)===null||_fm$image===void 0?void 0:(_fm$image$childImageS=_fm$image.childImageSharp)===null||_fm$image$childImageS===void 0?void 0:_fm$image$childImageS.gatsbyImageData),title:fm.title,excerpt:node.excerpt,date:fm.date,variant:variant})));})));}NewsList.propTypes={edges:(prop_types_default()).array,nodes:(prop_types_default()).array,limit:(prop_types_default()).number,start:(prop_types_default()).number,Card:(prop_types_default()).elementType,variant:(prop_types_default()).string,itemClassName:(prop_types_default()).string,listClassName:(prop_types_default()).string};
...
/* harmony export */ });
/* unused harmony exports MainImage, Placeholder, StaticImage, generateImageData, getImageData, getLowResolutionImageURL, getSrcSet, withArtDirection */
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(8250);
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(react__WEBPACK_IMPORTED_MODULE_0__);
