          ...
          <section className="py-24 px-4 bg-gradient-to-r from-orange-300 to-orange-600 bg-clip-text">
            ...
            <div className="flex flex-col gap-6 mb-10">
              <div className="flex flex-col sm:flex-row gap-6">
                ...
                <div className="flex-1 rounded-lg shadow-lg p-6 bg-github-pink text-gray-800">
                  <h2 className="text-3xl mb-2 font-semibold">
                    <a href="https://github.com/sponsors/crownengine">GitHub Sponsors</a>
                  </h2>
                  <p className="mb-6">
                ...
                <div className="flex-1 rounded-lg shadow-lg p-6 bg-paypal-blue text-gray-200">
                  <h2 className="text-3xl mb-2 font-semibold">PayPal</h2>
                  <div className="flex flex-col sm:flex-row">
                    <div className="flex-1 mb-6">
                      <p>We happily accept donations via PayPal. Pay with debit or credit cards!</p>
                    </div>
              ...
              <div className="flex-1 rounded-lg shadow-lg p-6 bg-gray-500 text-gray-200">
                <h2 className="text-3xl mb-2 font-semibold">Bank Transfer</h2>
                <h3 className="mb-6">
                  You can send payments directly to our bank account. Check your bank's commission
                  fees before donating if you live outside the European Union.
                </h3>
                <div className="flex flex-col sm:flex-row gap-6">
