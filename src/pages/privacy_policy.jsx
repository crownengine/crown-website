  ...
  return (
    <Layout pageInfo={{ pageName: "privacy_policy" }}>
      ...
      <div className="mx-2 lg:mx-32">
        <h2 className="text-center text-lg font-bold">Privacy Policy</h2>
        <p className="mt-4">
          Your privacy is important to us. It is The Crown Foundation's policy
        ...
        <p className="mt-4">This policy is effective as of 27 December 2020.</p>
        <p className="mt-4">
