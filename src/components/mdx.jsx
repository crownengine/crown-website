...
export const h2 = wrap("h2", "text-4xl font-extrabold mt-8 mb-6")
export const h3 = wrap("h3", "text-3xl font-bold mt-6 mb-3")
export const h4 = wrap("h4", "text-2xl font-semibold mt-4 mb-2")

export const p = wrap("p", "leading-relaxed mb-10 mt-10")
export const a = wrap("a", "text-blue-400 underline hover:text-blue-300")
...
export const blockquote = wrap("blockquote", "border-l-4 pl-4 italic bg-gray-800 p-2 rounded")

export const pre = function Pre({ className = "", ...props }) {
  return (
    <pre className={`overflow-x-auto p-4 rounded-md mb-4 bg-gray-800 text-gray-100 ${className}`} {...props} />
  )
}

export const code = function Code({ className = "", ...props }) {
  return <code className={`px-1 py-0.5 rounded bg-gray-700 text-gray-100 text-sm ${className}`} {...props} />
}
