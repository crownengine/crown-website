...
export const blockquote = wrap("blockquote", "border-l-4 pl-4 italic bg-gray-50 p-2 rounded")

export const pre = function Pre({ className = "", ...props }) {
  return (
    <pre className={`overflow-x-auto p-4 rounded-md mb-4 bg-gray-100 ${className}`} {...props} />
  )
}
