...
Full **Vulkan** rendering on Linux with better **XWayland + NVIDIA** compatibility, 15 new manual
pages, a new **HSV color picker**, a fast **flythrough camera mode**, and many editor tweaks and
fixes.
